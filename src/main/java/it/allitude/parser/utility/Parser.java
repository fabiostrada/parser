...
import static it.allitude.parser.utility.RegExUtility.regexGroup;
...
public class Parser {
    ...
    private List<String> groupsOfConditions() {
        Matcher matcherOfRegexGroup = matcherOf(filter, regexGroup());
    ...
    public static void main(String[] args) throws JsonProcessingException {
        String filter = "(destinatario contains pippo) _or_ (importo gt 3000 _and_ import lt 5000) _or_ (dataRicezione gt 2021/01/01 _and_ dataRicezione lte 2021/12/31)";
